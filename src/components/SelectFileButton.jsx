...
function SelectFileButton({ url, token, user, menu, setMenu, setAvatar }) {
    ...
    const handleDeleteAvatar = () => {
      const DELETE_URL = `${url}/users/me/avatar`
    ...
    return (
        <div className='flex flex-col mt-5 items-center justify-center' >
            <form className="flex flex-col bg-blue-500 shadow-md rounded px-8 pt-6 pb-8 mb-4" onSubmit={handleSubmit}>
                ...
                <input className="bg-white hover:bg-blue-200 text-gray-700 font-bold py-2 px-2 rounded focus:outline-none focus:shadow-outline mb-2" type="button" value="Delete Image" onClick={handleDeleteAvatar}/>
